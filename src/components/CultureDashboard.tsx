// Localização: src/components/CultureDashboard.tsx

"use client"; // Toda a interatividade vive aqui agora.

import { useState } from 'react';
import CultureCard from '@/components/ui/CultureCard';
import AddCultureModal, { NewCultureData } from '@/components/ui/AddCultureModal';
import CultureHistoryModal, { Culture, ImageHistory } from '@/components/ui/CultureHistoryModal';

// Os dados iniciais também se mudam para cá
const initialCultures: Culture[] = [
  ...
  { 
    ...
    status: 'critical',
    images: [
      { url: '/images/algodao.jpg', date: '19 de Julho de 2025' },
    ]
  },
  { 
    id: 4, 
...
export function CultureDashboard() {
  ...
  return (
    // O JSX que estava na página agora vive aqui.
    <>
